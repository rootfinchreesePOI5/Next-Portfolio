...
const Footer = () => {
  return (
    <div className='flex flex-col lg:flex-row  items-center gap-2 justify-center bg-navcolor text-textcolor border-t-2 border-zinc-800 px-[5%] py-8 lg:py-2 w-full'>
